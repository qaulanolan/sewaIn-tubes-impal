   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <input type="submit" value="delete product" name="delete" class="delete-btn" onclick="return confirm('delete this listing?');">
      </form>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">product not found! <a href="listings.php" style="margin-top:1.5rem;" class="option-btn">go to listings</a></p>';
   }
   ?>
